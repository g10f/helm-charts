...
{{- define "django-app.labelsMedia" -}}
helm.sh/chart: {{ include "django-app.chart" . }}
{{ include "django-app.selectorLabelsMedia" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- define "django-app.selectorLabelsMedia" -}}
app.kubernetes.io/name: {{ include "django-app.name" . }}-media
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
